...
<%@ Page Language="C#"
    ...
    CodeBehind="Frm_Cat_Tramites.aspx.cs"
    Inherits="web_red_alert.Paginas.Catalogos.Frm_Cat_Tramites" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Tramites.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Tr&aacute;mites</h3>
        </div>
        <div id="Principal"></div>
    </div>

    <div id="Modal"></div>
    <div id="Modal_Pasos"></div>
    <div id="Adjuntar"></div>
    <div id="VerAdjuntar"></div>
