...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Cat_Cartilla_Vacunacion.aspx.cs" 
    Inherits="web_red_alert.Paginas.Catalogos.Frm_Cat_Cartilla_Vacunacion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Cartilla_Vacunacion.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Cartilla de Vacunaci&oacute;n</h3>
        </div>
        <div id="Principal"></div>
    </div>
    
    <div id="Modal"></div>
    <div id="Modal_Asignacion"></div>
