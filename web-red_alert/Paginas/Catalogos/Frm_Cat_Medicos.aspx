...
<%@ Page Language="C#"
    ...
    CodeBehind="Frm_Cat_Medicos.aspx.cs"
    Inherits="web_red_alert.Paginas.Catalogos.Frm_Cat_Medicos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Medicos.js"></script>
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Medicos_Relacion.js"></script>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de M&eacute;dicos</h3>
        </div>
