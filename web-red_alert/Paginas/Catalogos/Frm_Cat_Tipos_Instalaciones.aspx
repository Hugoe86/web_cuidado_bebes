...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Cat_Tipos_Instalaciones.aspx.cs" 
    Inherits="web_red_alert.Paginas.Catalogos.Frm_Cat_Tipos_Instalaciones" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/catalogos/Js_Cat_Tipos_Instalaciones.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de Tipos de Instalaciones</h3>
        </div>
