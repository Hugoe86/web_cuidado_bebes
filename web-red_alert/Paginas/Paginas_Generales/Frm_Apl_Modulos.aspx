<%@ Page Title="Catálogo de Módulos" Language="C#" AutoEventWireup="true" 
    ...
    Inherits="web_red_alert.Paginas.Paginas_Generales.Frm_Apl_Modulos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container-fluid" style="height:100vh;">
        ...
        <div class="page-header" align="left">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Cat&aacute;logo de M&oacute;dulos</h3>
        </div>
        ...
        <div id="toolbar" style="margin-left: 5px;">
            <div class="btn-group" role="group" style="margin-left: 5px;">
                <button id="btn_salir" type="button" class="btn btn-info btn-sm" title="Get out"><i class="glyphicon glyphicon-home"></i></button>
