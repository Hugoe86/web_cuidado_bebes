...
<%@ Page Language="C#" 
    ...
    CodeBehind="Frm_Rpt_Usuarios.aspx.cs" 
    Inherits="web_red_alert.Paginas.Reportes.Frm_Rpt_Usuarios" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="../../Recursos/javascript/Reportes/Js_Rpt_Usuarios.js"></script>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container-fluid" style="height: 100vh;">
        <div class="page-header">
            <h3 style="font-family: 'Roboto Light', cursive !important; font-size: 24px; font-weight: bold; color: #808080;">Reporte de Usuarios</h3>
        </div>
