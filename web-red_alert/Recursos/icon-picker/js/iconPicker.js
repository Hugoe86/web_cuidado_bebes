    ...
    $.fn.iconPicker = function (options) {
        ...
        return this.each(function () {
            ...
            if (!settings.buttonOnly && $(this).data("iconPicker") == undefined) {
                ...
                $button = $("<span id='icono' class=\"input-group-addon pointer\"><i class=\"fa fa-picture-o\"></i></span>");
            ...
            function createUI($element) {
                ...
                $popup.html('<div class="ip-control"> \
						          <ul> \
						            <li><a href="javascript:;" class="btn" data-dir="-1"><span class="fa fa-backward"></span></a></li> \
						            <li><input type="text" class="ip-search fa  fa-search" placeholder="Search" /></li> \
						            <li><a href="javascript:;"  class="btn" data-dir="1"><span class="fa fa-forward"></span></a></li> \
						          </ul> \
						      </div> \
